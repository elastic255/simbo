...
BotnetAppMsg::BotnetAppMsg(const BotnetAppMsg& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}

BotnetAppMsg::~BotnetAppMsg()
{
}

BotnetAppMsg& BotnetAppMsg::operator=(const BotnetAppMsg& other)
{
...
void BotnetAppMsg::copy(const BotnetAppMsg& other)
{
...
void BotnetAppMsg::setAcao(int acao)
{
    this->acao = acao;
}

int BotnetAppMsg::getVulnerabilidade() const
{
    return this->vulnerabilidade;
}

void BotnetAppMsg::setVulnerabilidade(int vulnerabilidade)
{
    this->vulnerabilidade = vulnerabilidade;
}

int BotnetAppMsg::getDado() const
{
    return this->dado;
}
...
class BotnetAppMsgDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    BotnetAppMsgDescriptor();
    virtual ~BotnetAppMsgDescriptor();
...
BotnetAppMsgDescriptor::~BotnetAppMsgDescriptor()
{
    delete[] propertynames;
}

bool BotnetAppMsgDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<BotnetAppMsg *>(obj)!=nullptr;
}

const char **BotnetAppMsgDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *BotnetAppMsgDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *BotnetAppMsgDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BotnetAppMsgDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int BotnetAppMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string BotnetAppMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool BotnetAppMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    BotnetAppMsg *pp = (BotnetAppMsg *)object; (void)pp;
    switch (field) {
        case 0: pp->setAcao(string2long(value)); return true;
        case 1: pp->setVulnerabilidade(string2long(value)); return true;
        case 2: pp->setDado(string2long(value)); return true;
        default: return false;
    }
}

const char *BotnetAppMsgDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *BotnetAppMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
